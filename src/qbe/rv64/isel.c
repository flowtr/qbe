...
static int memarg(Ref *r, int op, Ins *i) {
...
static int immarg(Ref *r, int op, Ins *i) {
...
static void negate(Ref *pr, Fn *fn) {
  Ref r;
...
static void selcmp(Ins i, int k, int op, Fn *fn) {
  Ins *icmp;
  Ref r, r0, r1;
  int sign, swap, neg;
